...
#[unsafe(no_mangle)]
pub extern "C" fn luago_thread_status(t: *mut mluau::Thread) -> u8 {
    wrap_failable(|| {
...
#[unsafe(no_mangle)]
pub extern "C" fn luago_thread_equals(t: *mut mluau::Thread, t2: *mut mluau::Thread) -> bool {
    wrap_failable(|| {
...
#[unsafe(no_mangle)]
pub extern "C" fn luago_free_thread(t: *mut mluau::Thread) {
    wrap_failable(|| {
        // Safety: Assume t is a valid, non-null pointer to a Lua thread
        if t.is_null() {
            return;
